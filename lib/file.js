...
exports.createReportName = function (desiredName) {
	...
	if (desiredName) {
		if (typeof desiredName !== "string") {
			desiredName = desiredName.map(function (name) {
				return name.substring(0, name.lastIndexOf("_"));
			}).join("_");
		}
		desiredName = path.basename(desiredName);

		// Maximum 125 character... I don't like long names
...
/**
 * Convert new lines from different operating systems into a single '\n'
 * @param  {String} content File to be converted
 * @return {String} converted file
 */
exports.normalizeNewLines = function (content) {
