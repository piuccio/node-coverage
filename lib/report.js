...
function generateAll (descriptor) {
	...
	report.functions = descriptor.runFunctions;
	...
	report.global.conditionsPercentage = report.global.conditions ?
		50.0 * (report.global.conditionsTrue + report.global.conditionsFalse) / report.global.conditions
		: 100;
	report.global.functionsPercentage = report.global.functions ?
		100.0 * report.global.functionsCalled / report.global.functions:
		100;
